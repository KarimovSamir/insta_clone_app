export const SETTINGS = {
    ...
    FRONTEND_CONFIRM_URL:
        ...
        "https://insta-clone-app-kappa.vercel.app/registration-confirmation",
    FRONTEND_RECOVERY_CODE_URL:
        process.env.FRONTEND_RECOVERY_CODE_URL ||
        "https://insta-clone-app-kappa.vercel.app/password-recovery",
    APP_BASE_URL:
        process.env.APP_BASE_URL || "https://insta-clone-app-kappa.vercel.app",
};
